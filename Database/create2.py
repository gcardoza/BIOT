...
conn.execute('''CREATE TABLE IF NOT EXISTS Irrigation_Schedule
	(Program          TEXT,
	  Zone1_OnTime    INT,
	  Zone2_OnTime    INT,
    Zone3_OnTime    INT,
    ...
    Zone7_OnTime    INT,
    Zone8_OnTime    INT);''')
print ("  -> Irrigation_Schedule Table created successfully")
conn.execute("INSERT INTO Irrigation_Schedule (Program, Zone1_OnTime, Zone2_OnTime, Zone3_OnTime, Zone4_OnTime, Zone5_OnTime, Zone6_OnTime, Zone7_OnTime, Zone8_OnTime) \
	VALUES ('Program1', 1800, 1800, 1800, 3600, 3600, 3600, 0, 0)");
print ("  -> Irrigation_Schedule Table seeded successfully")
...
conn.execute('''CREATE TABLE IF NOT EXISTS Zone_Status
    ...
    Zone_OnTime     INT);''')
print ("  -> Irrigation_Schedule Table created successfully")
print ("  -> Irrigation_Schedule Table seeded by RioT3 Status Updates")
